...
if($target=="staff_reg") 
	...
	echo'<a href="'.$thisfile.URL_APPEND.'&target=staff_reg"><img '.createLDImgSrc($root_path,'add_employee_gray.gif','0').' alt="'.$LDAdmit.'"'; echo '></a>';
}
if($target=="staff_search") 
	echo '<img '.createLDImgSrc($root_path,'src_emp_blu.gif','0').' alt="'.$LDSearch.'">';
else{ 
	echo '<a href="'.$thisfile.URL_APPEND.'&target=staff_search"><img '.createLDImgSrc($root_path,'src_emp_gray.gif','0').' alt="'.$LDSearch.'" '; echo '></a>';
}
if($target=="staff_listall") 
	echo '<img '.createLDImgSrc($root_path,'lista-blu.gif','0').' alt="'.$LDSearch.'">';
else{ 
	echo '<a href="'.$thisfile.URL_APPEND.'&target=staff_listall"><img '.createLDImgSrc($root_path,'lista-gray.gif','0').' alt="'.$LDSearch.'" ';echo '></a>';
}
...
if($target=="person_reg") 
	...
	echo '<a href="'.$thisfile.URL_APPEND.'&target=person_reg"><img '.createLDImgSrc($root_path,'register_gray.gif','0').' alt="'.$LDSearch.'" ';echo '></a>';
}
?></td>
</tr>
